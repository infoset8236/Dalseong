						...
						(e.prototype.fromElement = function (a) {
							...
							null == this.options.multiple && (this.options.multiple = a.prop('multiple')),
								...
								null == this.options.language &&
									(a.prop('lang') ? (this.options.language = a.prop('lang').toLowerCase()) : a.closest('[lang]').prop('lang') && (this.options.language = a.closest('[lang]').prop('lang'))),
								null == this.options.dir &&
									(a.prop('dir') ? (this.options.dir = a.prop('dir')) : a.closest('[dir]').prop('dir') ? (this.options.dir = a.closest('[dir]').prop('dir')) : (this.options.dir = 'ltr')),
...
$(function () {
	...
	// 갤러리 게시판 이미지
	$('#board_tbody.bbs_gallery li img').error(function () {
	...
	*/
	...
	if ($current) {
		if (!$curli.hasClass('selected')) $curli.first().addClass('selected');
